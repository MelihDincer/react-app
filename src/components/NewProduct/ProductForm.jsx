...
const ProductForm = (props) => {
    ...
    return (
        <div className="card mt-4">
            <div className="card-header">ÜRÜN EKLEME PANELİ</div>
            ...
            <form className="form-group" onSubmit={submitHandler}>
                ...
                <div className="d-grid">
                    <button className="btn btn-primary mb-1">Ürün Ekle</button>
                    <button onClick={() => props.setIsOpen(false)} className="btn btn-danger mb-3" type="button">Vazgeç</button>
                </div>
            </form>
            </div>
        </div>
